 ...
 *This playground 🎉 the giants of our past and takes a look towards our future. A future that you and I can build.*
...
view.backgroundColor = /*#-editable-code placeholder text*/.black/*#-end-editable-code*/
//: Now we're going to need stars.
//: * Set the value passed into addStars() to **true**
//: * **Run** your program to see the magic ✨
addStars(/*#-editable-code placeholder text*/false/*#-end-editable-code*/)
